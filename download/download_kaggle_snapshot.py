...
def main():
    parser = argparse.ArgumentParser(description='Download arXiv snapshot from Kaggle and upload to S3 or local.')
    parser.add_argument('--output', required=True, help='Output path: local folder or S3 URI (e.g., s3://bucket/path)')
